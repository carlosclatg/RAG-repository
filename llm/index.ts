...
export type GeneratorResult = { success: true; data: string } | { success: false; error: string };

export async function generateResponse(query: string, finalContext: string): Promise<GeneratorResult> {
    try {
        ...
        if (error.code === 'ECONNREFUSED') {
            message = "No se pudo conectar con Ollama. ¿Está el servidor encendido?";
